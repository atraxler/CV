...
\begin{tabular}{L!{\VRule}R}
	%\begin{longtable}{L!{\VRule}R}
	& \bibentry{brewe_transitioning}\\
	& \bibentry{commeford_characterizing_2021}\\
...
\squishlist
\item Kelley Commeford (co-advisor, PhD expected spring 2021)
\item Hannah Benston (MS expected fall 2021)
...
\squishlist
\item \textbf{PERLOC} (Physics Education Research Leadership and Organizing Council); Member, January 2020--present, Vice-chair, January 2021--present
