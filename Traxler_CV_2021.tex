...
2021 	& \bibentry{brewe_transitioning_2021}\\
...
%\begin{itemize}
\squishlist
\item \textbf{Undergraduate Physics Seminar I (PHY 1000, 1 credit.)} (F2018, F2019, F2020) Introductory undergraduate seminar, 5--10 students. %First-year seminar taken by physics majors to orient them to the department, build community, and develop laboratory skills. 
...
\squishlist
\item Hannah Benston (MS physics expected fall 2021)
...
\item Past: Russell Clark (MST, 2016), Melody Deitrick (MST, 2020)
\squishend
