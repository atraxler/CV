...
2020 	& \bibentry{wells_2020_exploring}\\
...
%\begin{tabular}{L!{\VRule}R}
\begin{longtable}{L!{\VRule}R}
2020 	& \bibentry{traxler_MSU_2020}\\
...
\begin{longtable}{L!{\VRule}R}
%2020	& \bibentry{traxler_CALEPposter_2020}\\[5pt]
%		& \bibentry{traxler_SSTEMtalk_2020}\\[5pt]
...
\item \textbf{General Physics I (PHY 2400, 4 credits).} (F2014, Su2015, F2015, Sp2016, F2016, F2017, F2018, F2019, Sp2020) Introductory undergraduate, 10--220 students. Calculus-based course covering Newtonian mechanics. %taken by physics and engineering majors covering Newtonian mechanics (kinematics, forces, energy, momentum, rotation, oscillations). 
...
(Sp2017, Sp2018, Sp2019, Sp2020) Upper-division undergraduate and cross-listed as graduate, 10--20 students. %Course for physics and applied mathematics majors covering
...
\squishlist
\item Kelley Commeford (co-advisor, PhD expected 2020)
\item Raym Alzahrani (MS 2016)
\item Sarah Hierath (MS 2016)
\item Emily Sandt (MS 2016)
\squishend
...
Russell Clark (MST, 2016), Melody Deitrick (MST, 2020)
...
\item \textbf{PERLOC} (Physics Education Research Leadership and Organizing Committee), January 2020--present
\squishend
