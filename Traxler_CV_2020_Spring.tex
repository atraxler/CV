...
\begin{tabular}{L!{\VRule}R}
	%\begin{longtable}{L!{\VRule}R}
	2020 (expected)	& \bibentry{traxler_disability_2020}\\
	& \bibentry{traxler_climatechap_2020}\\
	%\end{longtable}
\end{tabular}
...
\begin{tabular}{L!{\VRule}R}
	%\begin{longtable}{L!{\VRule}R}
	& \bibentry{traxler_network_2020}\\
	& \bibentry{commeford_characterizing_2020}\\
	%\end{longtable}
\end{tabular}
...
%\begin{itemize}
\squishlist
\item \textbf{Undergraduate Physics Seminar I (PHY 1000, 1 credit.)} (F2018, F2019) Introductory undergraduate seminar, 5--10 students. %First-year seminar taken by physics majors to orient them to the department, build community, and develop laboratory skills. 

\item \textbf{General Physics I (PHY 2400, 4 credits).} (F2014, Su2015, F2015, Sp2016, F2016, F2017, F2018, F2019) Introductory undergraduate, 30--220 students. Calculus-based course covering Newtonian mechanics. %taken by physics and engineering majors covering Newtonian mechanics (kinematics, forces, energy, momentum, rotation, oscillations). 

\item \textbf{Introduction to Astrophysics (PHY 3300, 3 credits).} (Sp2018, Sp2019) Upper-division undergraduate, 5--15 students. Developed new astrophysics course. 

\item \textbf{Analytical Mechanics (PHY 3710/5710, 3 credits).}
(Sp2017, Sp2018, Sp2019) Upper-division undergraduate and cross-listed as graduate, 10--20 students. %Course for physics and applied mathematics majors covering
...
(F2015, Sp2016, Su2016, F2017, Sp2017, Su2017, F2017, Sp2018) Graduate, independent study format, 1--3 students. Thesis project credits.
%\end{itemize}
\squishend
...
\squishlist
\item \textbf{American Physical Society}  Forum on Education Member-at-Large, Spring 2019--present.
...
\item \textbf{PERLOC} (Physics Education Research Leadership and Organizing Committee), elected to term starting January 2020
\squishend
...
\squishlist
\item \textbf{Journals:} Science Advances, American Journal of Physics, Physical Review Physics Education Research, European Journal of Physics, The Physics Teacher, Physics Education Research Conference Proceedings, International Journal of Research and Method in Education, CBE – Life Sciences Education
