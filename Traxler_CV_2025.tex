...
2024	& \bibentry{traxler_person_2024}\\
		& \bibentry{gutzwa_how_2024}\\
		& \bibentry{green_sentiment_2024}\\
...
\begin{tabular}{L!{\VRule}R}
	%\begin{longtable}{L!{\VRule}R}
2024 	& \bibentry{hernandez-garcia_community_2024}\\
...
\begin{tabular}{L!{\VRule}R}
%\begin{longtable}{L!{\VRule}R}
	& \bibentry{hatcher_critical_2025}\\
%\end{longtable}
\end{tabular}
...
%\begin{tabular}{L!{\VRule}R}
\begin{longtable}{L!{\VRule}R}
2024	& \bibentry{noehr_critical_2024}\\[5pt]
...
\begin{longtable}{L!{\VRule}R}
%2025	& \bibentry{traxler_ESERA_2025}\\
%		& \bibentry{barany_ESERA_2025}\\
%		& \bibentry{sundstrom_ESERA_2025}\\
%		& \bibentry{watanabe_ESERA_2025}\\		
2024	& \bibentry{traxler_ICQE_2024}\footnote{Awarded best poster.}\\
		& \bibentry{misfeldt_ICQE_2024}\\
		& \bibentry{traxler_Sunbelt_2024}\\
...
\squishlist
	\item \textbf{Introduction to University Pedagogy} (Nov2022, Jan2023, Apr2023, Sep2023, Dec2023, Apr2024, Nov2024) Week-long intensive course for university teaching, 20--24 participants. 
	\item \textbf{University Pedagogy (Universitetspædagogikum)} (Nov2022, Aug2023, Aug2024) Theoretical and practical course in university teaching, 20--24 participants. 
\squishend
...
\squishlist
\item Current: Madison Swirtz (PhD candidate, physics), Colin Greene (PhD candidate, physics)
\item Past: Justin Gambrell (PhD physics, 2024), Hope Strickland (EdD, 2023), Colin Green (MS physics, 2022), Russell Clark (MST, 2016), Melody Deitrick (MST, 2020)
\squishend
...
\squishlist
\item \textbf{Physical Review Physics Education Research} Editorial Board, Summer 2024--
