...
\begin{tabular}{L!{\VRule}R}
2022--present & {\bf Associate Professor of Science Education}, University of Copenhagen, K\o{}benhavn, Denmark.\\
...
%\paragraph{Novo Nordisk Foundation:} Courageous Collaborative Science. 
...
%\begin{tabular}{L!{\VRule}R}
\begin{longtable}{L!{\VRule}R}
2023	& \bibentry{traxler_HelsPhys_2023}\\
...
\squishlist
	\item \textbf{Introduction to University Pedagogy} (Nov2022, Jan2023, Apr2023) Week-long intensive course for university teaching, 20--24 participants. 
	\item \textbf{University Pedagogy (Universitetspædagogikum)} (Nov2022) Theoretical and practical course in university teaching, 20--24 participants. 
\squishend
